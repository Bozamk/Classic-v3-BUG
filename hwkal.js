...
//—————「 Set Nama Own & Bot 」—————//
global.ownername = '𝚂𝙰𝚃𝙷𝙼𝙸𝙽 𝙾𝙵𝙲!' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.owner = ['94761681904'] // ubah aja pake nomor lu
//==========================zetsuboclient=======================//
...
global.author = 'ᴹᴿ ˢᴬᵀᴴᴹᴵᴺ' // ubah aja ini nama sticker
global.prefa = ['','!','.',',','🐤','🗿']
